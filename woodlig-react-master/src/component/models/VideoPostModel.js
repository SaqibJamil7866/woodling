...
import 'react-toastify/dist/ReactToastify.css'; 
 const { Option } = Select;
class VideoPostModel extends React.Component {
  constructor(props) {
      super(props); 
      this.state = { 
  ...
  handleSubmit(e) {
    ...
    for (var i = 0; i < this.state.selectedFile.length; i++) {
        formData.append( this.state.uploadType+'_'+i, this.state.selectedFile[i]);  
    }
               ...
               <form role="form" onSubmit={this.handleSubmit}>
                      <div className="modal-body">
                          ...
                          <div className="status_update_details">
                                  <FileUploadComponent  uploadType={this.state.uploadType} mxsize="2" sendCallBack={this.reciveImageCallBack}/>  
