      ...
      <div className="h100p scrolling">
        <div className="row d-flex m0">
          <div className="col-md-8 br-white pl100">
            <div className="mt20">
              <h1>
                <b>Post A Casting Call</b>
              </h1>
              <p>
                <b>Note:</b>Posting a casting call costs $5 ifyou don't have
                free calls.
                <br />
                For more information on posting a casting call{' '}
                <Link>Learn more</Link>
              </p>
            </div>
            <form onSubmit="" className="forms">
              <div className="clr__white p35 border-radius">
                <p className="fs25 alignCenter">
                  <b>Casting Call Details</b>
                </p>
                <div className="form-group">
                  ...
                  />
                  {errors.title && (
                    <p className="alert alert-danger error">{errors.title}</p>
                  )}
                </div>
                <div className="form-group">
                  ...
                  <select
                    ...
                    id="inputState"
                    className="form-control w35 bold box-shadow-none"
                    placeholder="Gender"
                  >
                ...
                return (
                  <div className="clr__white mt20 p35">
                    <div className={index > 0 ? 'd-flex space-between' : null}>
                      ...
                      <p
                        className={index > 0 ? 'clr__red pointer' : 'noDisplay'}
                    ...
                    <div className="form-group">
                      ...
                      <select
                        value={role_type[index].role_type_id}
                        onChange={this.handleRoleType(index)}
                        name="role_type_id"
                        id="inputState"
                        className="form-control w30 bold box-shadow-none"
                        placeholder="Gender"
                      >
                      ...
                      <div>
                        {gender.map((i, ind) => {
                          ...
                          return (
                            <>
                              <input
                                className="form-check-input pointer zero-opacity"
                                type="radio"
                                name="gender"
                                id={ind}
                                value={role_type[index].gender}
                                onChange={this.handleGenderChange(index, i.id)}
                              />
                              <label
                                className={
                                  genderChange === i.id
                                    ? 'form-check-label pointer mr40 red'
                                    : 'form-check-label pointer mr40'
                                }
                                for={ind}
                              >
                                {i.name}
              ...
              <div className="d-flex space-between">
                <img
                  style={{ width: '25%' }}
                  className="pointer"
                  src={require('../assets/processed-btn.svg')}
                />
                <div className="d-flex align-items-center">
                  <i className="fa fa-plus clr__red" />
                  <p onClick={this.addRole} className="m0 p0 clr__red pointer">
                    <b>Add Another Role</b>
                  </p>
                </div>
              </div>
            </form>
