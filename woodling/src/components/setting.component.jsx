...
import EditFAQ from './common/edit-faq.component';
import EditAbout from './common/edit-about.component';
    ...
    return (
      <div className="h100p scrolling">
        <div className="row m0">
          <h1 className="mt10 p20 ml20 w100p">
            <b>Settings</b>
          </h1>
          <div className="col-md-4 clr__white border-right">
            <div className="d-flex flex-dir-col align-item">
              <div className="d-flex align-item w80">
                ...
                <img
                  ...
                  src={require('../assets/profileSetting.svg')}
                />
              </div>
            ...
            <div className="d-flex flex-dir-col align-item mt20">
              ...
              <div
                onClick={this.logout}
                className="d-flex align-item w80 pointer"
              >
                <h3 className="mb0 clr__red">
                  <b>Logout</b>
                </h3>
                <i className="fa fa-sign-out ml5 fs25 clr__red" />
              </div>
            </div>
          </div>
