  ...
  constructor(props) {
    ...
    this.state = {
      ...
      bottomIcons: [
        {
          path:
            '/chat' /* path is used as id to check which NavItem is active basically */,
          name: 'Chat',
          imgsrc: (
            <MailIcon alt="Chat icon" title="Chat" height="30px" width="29px" />
          ),
        ...
        },
        {
          ...
          name: 'Settings',
          imgsrc: (
            <CogIcon alt="Settings icon" title="Settings" height="30px" />
          ),
          key: 13,
        },
        {
          ...
          name: 'Search',
          imgsrc: (
            <MainSearchIcon alt="Search icon" title="Search" height="30px" />
          ),
          key: 14,
        },
        {
...
class NavItem extends React.Component {
  ...
  handleClick = (e) => {
    ...
    if (path === '/alerts') {
      // Don't navigate on alert's icon click
      e.preventDefault();
