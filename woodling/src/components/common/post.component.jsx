...
function Post(props) {
    return (
        <div className="mt30 top-content-bar container row" style={{width: '700px'}}>
            <div className="col-md-6">
                ...
                <div>
                    This is dummy contect for testing purpose of web application of woodling websote.
                    Will you accept it for this to that.
                </div>
                <div className="border-top">
                    ...
                    <span className="mr20 navy">
                        ...
                        <span className="badge  mr20">80</span>
                    </span>
                    <span> 1h</span>
                </div>
            </div>
