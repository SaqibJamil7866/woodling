    ...
    return ( 
        <div className='clr__white w45 d-flex flex-dir-col p15 border-radius-20 '>
            ...
            <div>
                ...
                {from==='jobs' ?<p className='w100p align-right fs17'>You have {data.length} casting calls posted</p> : <p className='w100p align-right fs17'>You have sent an application to {data.length} casting calls</p>}
            </div>
        </div>
    );
}
